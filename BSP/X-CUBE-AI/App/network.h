...
#define AI_NETWORK_IN_1_SIZE  (1 * 1 * 100)
#define AI_NETWORK_IN_1_SIZE_BYTES  ((1 * 1 * 100) * 4)
...
#define AI_NETWORK_OUT { \
  AI_BUFFER_OBJ_INIT(AI_BUFFER_FORMAT_FLOAT, 48, 48, 1, 1, NULL), \
}
#define AI_NETWORK_OUT_SIZE { \
  (48 * 48 * 1), \
}
#define AI_NETWORK_OUT_1_SIZE  (48 * 48 * 1)
#define AI_NETWORK_OUT_1_SIZE_BYTES  ((48 * 48 * 1) * 4)
